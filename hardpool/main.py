...
#load images
cue_image = pygame.image.load("D:\\BINUS\\Final Project Algorithm & Programming\\hardpool\\images\\cue.png").convert_alpha()
table_image = pygame.image.load("D:\\BINUS\\Final Project Algorithm & Programming\\hardpool\\images\\table.png").convert_alpha()
ball_images = []
for i in range(1, 17):
  ball_image = pygame.image.load(f"D:\\BINUS\\Final Project Algorithm & Programming\\hardpool\\images\\ball_{i}.png").convert_alpha()
